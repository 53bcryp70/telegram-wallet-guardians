...
This repository is a **12-hour hackathon prototype**, not a production wallet-security product. These instructions are authoritative. If another file conflicts with this file, this file wins. Do not add product code until the cryptographic checkpoint in section 8 passes.
